...
/*   Updated: 2024/12/06 17:55:28 by halozdem         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (philo->chair_no % 2 == 0 || (philo->t_data->number_of_philo != 1
...
void	*routine(void *arg)
{
	...
	while (1)
	{
		...
		if (philo->eat_count == philo->t_data->nbr_of_times_eat)
			philo->t_data->completed_philos++;
		if (philo->t_data->completed_philos >= philo->t_data->number_of_philo)
